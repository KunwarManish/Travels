							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										<!-- Image -->
										<div class="offers_image_background" style="background-image:url(<?php echo url('/'); ?>/images/offer_11.jpg)"></div>
										<div class="offer_name"><a href="single_listing.html">Grand Chola</a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price">$320<span>per night</span></div>
										...
										<p class="offers_text">The ITC Grand Chola is a 5-star luxury hotel in Chennai, India. It is the third largest hotel in India after Renaissance Mumbai Convention Centre Hotel and Grand Hyatt, both in Mumbai. It is located in Guindy, opposite SPIC building and along the same row of buildings as Ashok Leyland Towers. The building, designed by Singapore-based SRSS Architects, is of mixed-use development with three separate wings and is themed after traditional Tamilian Architecture of the Chola Dynasty. </p>
										<div class="offers_icons">
											<ul class="offers_icons_list">
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/post.png" alt=""></li>
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/compass.png" alt=""></li>
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/bicycle.png" alt=""></li>
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/sailboat.png" alt=""></li>
											</ul>
										</div>
						...
						<div class="offers_item rating_3">
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										<!-- Image -->
										<div class="offers_image_background" style="background-image:url(<?php echo url('/'); ?>/images/offer_9.jpg)"></div>
										<div class="offer_name"><a href="single_listing.html">soaltee hotel</a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										...
										<p class="offers_text">Luxurious accommodation in Kathmandu is provided at Crowne Plaza Hotel Kathmandu-Soaltee, spread over 12 acres of peaceful gardens. An outdoor pool, spa treatments and a fitness centre are available. It also has outdoor barbecue grills and a global newspaper service.</p>
										<div class="offers_icons">
											<ul class="offers_icons_list">
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/post.png" alt=""></li>
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/compass.png" alt=""></li>
						...
						<div class="offers_item rating_5">
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										<!-- Image -->
										<div class="offers_image_background" style="background-image:url(<?php echo url('/'); ?>/images/offer_0.jpg)"></div>
										<div class="offer_name"><a href="single_listing.html">Emirates Palace </a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price">$510<span>per night</span></div>
										...
										<p class="offers_text">Experience world-class service at Emirates Palace, Abu Dhabi, offering luxurious rooms and suites, fine dining, private spa and wedding.</p>
										<div class="offers_icons">
											<ul class="offers_icons_list">
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/post.png" alt=""></li>
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/compass.png" alt=""></li>
						...
						<div class="offers_item rating_4">
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										<!-- Image -->
										<div class="offers_image_background" style="background-image:url(<?php echo url('/'); ?>/images/offer_10.jpg)"></div>
										<div class="offer_name"><a href="single_listing.html">Kandima Maldives</a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price">$350<span>per night</span></div>
										<div class="rating_r rating_r_4 offers_rating" data-rating="4">
											<i></i>
											<i></i>
											<i></i>
										...
										<p class="offers_text">Experience world-class service at Kandima Maldives Located on the largest island in Dhaalu Atoll, Kandima Maldives has the longest outdoor swimming pool in the Maldives, an abundance of water-sports, the largest beach club and tennis and basketball courts. It offers a marine biology centre, an art studio and cooking classes. Kandima Maldives is a stylish lifestyle island resort with smart rooms, extraordinary restaurants & bars and tons of cool activities.</p>
										<div class="offers_icons">
											<ul class="offers_icons_list">
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/post.png" alt=""></li>
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/compass.png" alt=""></li>
						...
						<div class="offers_item rating_3">
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										<!-- Image -->
										<div class="offers_image_background" style="background-image:url(<?php echo url('/'); ?>/images/offer_12.jpg)"></div>
										<div class="offer_name"><a href="single_listing.html">Hôtel Le Cep</a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										...
										<p class="offers_text">The Hotel Le Cep and Spa Marie de Bourgogne, member of the Small Luxury Hotels of the World and Chateaux & Hotels Collection, is ideally located in the heart of the medieval city of Beaune, capital of the wines of Burgundy.</p>
										<div class="offers_icons">
											<ul class="offers_icons_list">
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/post.png" alt=""></li>
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/compass.png" alt=""></li>
										...
										<div class="offer_reviews">
											...
											<div class="offer_reviews_rating text-center">6.8</div>
										</div>
						...
						<div class="offers_item rating_4">
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										<!-- Image -->
										<div class="offers_image_background" style="background-image:url(<?php echo url('/'); ?>/images/offer_13.jpg)"></div>
										<div class="offer_name"><a href="single_listing.html">Grand Hyatt Goa </a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										...
										<p class="offers_text">Elegant, contemporary rooms come with terraces, flat-screen TVs, free Wi-Fi and minibars, plus tea and coffeemaking facilities. Upgraded rooms add whirlpool baths, sea views and access to a club lounge; some include dining areas.</p>
										<div class="offers_icons">
											<ul class="offers_icons_list">
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/post.png" alt=""></li>
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/compass.png" alt=""></li>
					...
					<div class="offers_item rating_4">
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										<!-- Image -->
										<div class="offers_image_background" style="background-image:url(<?php echo url('/'); ?>/images/offer_14.jpg)"></div>
										<div class="offer_name"><a href="single_listing.html">hotel löwen </a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price">$120<span>per night</span></div>
										<div class="rating_r rating_r_4 offers_rating" data-rating="4">
											<i></i>
											<i></i>
											<i></i>
										...
										<p class="offers_text">Featuring a heated pool with sauna and a terrace with panoramic views of Mount Feldberg, this traditional hotel in St. Märgen offers a quiet location in the Black Forest.
										A hearty breakfast buffet and cuisine from the Baden region are served in the Löwen’s restaurant. Lactose- and gluten-free dishes are available on request.</p>
										<div class="offers_icons">
											<ul class="offers_icons_list">
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/post.png" alt=""></li>
												<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/compass.png" alt=""></li>
										...
										<div class="offer_reviews">
											...
											<div class="offer_reviews_rating text-center">7.6</div>
										</div>
									</div>
								</div>
							</div>
