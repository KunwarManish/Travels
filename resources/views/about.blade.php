...
<div class="super_container">
	...
	<div class="intro">
		<div class="container">
			<div class="row">
				<div class="col-lg-7">
					<div class="intro_image"><img src="<?php echo url('/'); ?>/images/intro.png" alt=""></div>
				</div>
				<div class="col-lg-5">
					<div class="intro_content">
						<div class="intro_title">we have the best tours</div>
						<p class="intro_text">WE'RE LOCALS! We bargain best deals for you. Lowest Price is Always Guaranteed! When local starts to compete, its always best for customers. The are fair traders.All the operators and their products listed in Travels are Verified. Our verification process includes of Guarantee of Operation, Verification of Legal Status, Availability of Products and Government License Verification.</p>
				...
				<div class="col">
					<div class="stats_contents">
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								<div class="stats_last_icon d-flex flex-column align-items-center justify-content-end">
									<img src="<?php echo url('/'); ?>/images/stats_1.png" alt="">
								</div>
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								<div class="stats_last_icon d-flex flex-column align-items-center justify-content-end">
									<img src="<?php echo url('/'); ?>/images/stats_2.png" alt="">
								</div>
								<div class="stats_last_content">
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								<div class="stats_last_icon d-flex flex-column align-items-center justify-content-end">
									<img src="<?php echo url('/'); ?>/images/stats_3.png" alt="">
								</div>
								<div class="stats_last_content">
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								<div class="stats_last_icon d-flex flex-column align-items-center justify-content-end">
									<img src="<?php echo url('/'); ?>/images/stats_4.png" alt="">
								</div>
								<div class="stats_last_content">
			...
			<div class="row">
				<div class="col">
					<div class="add_container">
						<div class="add_background" style="background-image:url(<?php echo url('/'); ?>/images/add.jpg)"></div>
			...
			<div class="row">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="<?php echo url('/'); ?>/images/milestone_1.png" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="<?php echo url('/'); ?>/images/milestone_2.png" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="<?php echo url('/'); ?>/images/milestone_3.png" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="<?php echo url('/'); ?>/images/milestone_4.png" alt=""></div>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="/blog">office</a></li>
