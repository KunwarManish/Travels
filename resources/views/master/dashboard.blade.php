...
<head>
  ...
  <!-- Bootstrap core css/ -->
  <link href="<?php echo url('/'); ?>/admindas/css/bootstrap.min.css/" rel="stylesheet">
  <!-- Material Design Bootstrap -->
  <link href="<?php echo url('/'); ?>/admindas/css/mdb.min.css/" rel="stylesheet">
  <!-- Your custom styles (optional) -->
  <link href="<?php echo url('/'); ?>/admindas/css/style.min.css/" rel="stylesheet">
  <style>
...
<body class="grey lighten-3">
  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
        <img src="https://mdbootstrap.com/<?php echo url('/'); ?>/admindas/img/logo/mdb-email.png" class="img-fluid" alt="">
      </a>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        <div class="col-3 text-center">
                          <img src="https://mdbootstrap.com/<?php echo url('/'); ?>/admindas/img/Photos/Avatars/img%20(1).jpg" alt="Michal Szymanski - founder of Material Design for Bootstrap"
              ...
              <div class="modal fade" id="modalLoginAvatarDemo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog cascading-modal modal-avatar modal-sm" role="document">
                  ...
                  <div class="modal-content">
                    ...
                    <!--Header-->
                    <div class="modal-header">
                      <img src="https://mdbootstrap.com/<?php echo url('/'); ?>/admindas/img/Photos/Avatars/img%20%281%29.jpg" class="rounded-circle img-responsive"
                        alt="Avatar photo">
                    </div>
                    <!--Body-->
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <img src="https://mdbootstrap.com/<?php echo url('/'); ?>/admindas/img/brandflow/modal4.jpg" alt="MDB graphics" class="img-fluid z-depth-1">
                  <div class="text-center">
                ...
                <div class="col-md-3">
                  ...
                  <img src="https://mdbootstrap.com/<?php echo url('/'); ?>/admindas/img/brandflow/modal3.jpg" alt="MDB graphics" class="img-fluid z-depth-1">
                  <div class="text-center">
                    <h5 class="my-3">Position</h5>
                ...
                <div class="col-md-3">
                  ...
                  <img src="https://mdbootstrap.com/<?php echo url('/'); ?>/admindas/img/brandflow/modal2.jpg" alt="MDB graphics" class="img-fluid z-depth-1">
                  <div class="text-center">
                ...
                <div class="col-md-3">
                  ...
                  <img src="https://mdbootstrap.com/<?php echo url('/'); ?>/admindas/img/brandflow/modal1.jpg" alt="MDB graphics" class="img-fluid z-depth-1">
                  <div class="text-center">
                    <h5 class="my-3">Position</h5>
  ...
  <!-- SCRIPTS -->
  <!-- JQuery -->
  <script type="text/javascript" src="<?php echo url('/'); ?>/admindas/js/jquery-3.4.1.min.js"></script>
  <!-- Bootstrap tooltips -->
  <script type="text/javascript" src="<?php echo url('/'); ?>/admindas/js/popper.min.js"></script>
  <!-- Bootstrap core JavaScript -->
  <script type="text/javascript" src="<?php echo url('/'); ?>/admindas/js/bootstrap.min.js"></script>
  <!-- MDB core JavaScript -->
  <script type="text/javascript" src="<?php echo url('/'); ?>/admindas/js/mdb.min.js"></script>
  <!-- Initializations -->
