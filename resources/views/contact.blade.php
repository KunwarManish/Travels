...
<link rel="stylesheet" type="text/css" href="<?php echo url('/'); ?>/styles/contact_styles.css">
...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="<?php echo url('/'); ?>/images/contact_background.jpg"></div>
			...
			<div class="row">
				<div class="col-lg-5">
					...
					<div class="about_image">
						<img src="<?php echo url('/'); ?>/images/man.png" alt="">
					</div>
				...
				<div class="col-lg-4">
					...
					<div class="about_content">
						...
						<p class="about_text">We are committed to offering travel services of the highest quality, combining our energy and enthusiasm, with our years of experience. Our greatest satisfaction comes in serving large numbers of satisfied clients who have experienced the joys and inspiration of travel.</p>
					...
					<div class="about_info">
						<ul class="contact_info_list">
							...
							<li class="contact_info_item d-flex flex-row">
								...
								<div class="contact_info_text"><a href="mailto:contactme@gmail.com?Subject=Hello" target="_top">travels@gmail.com</a></div>
							</li>
							<li class="contact_info_item d-flex flex-row">
								<div><div class="contact_info_icon"><img src="<?php echo url('/'); ?>/images/planet-earth.svg" alt=""></div></div>
								<div class="contact_info_text"><a href="Manish Kunwar">Manish Kunwar</a></div>
							</li>
						</ul>
					</div>
					...
					<div class="footer_col">
						...
						<div class="footer_content footer_contact">
							<ul class="contact_info_list">
								...
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="<?php echo url('/'); ?>/images/message.svg" alt=""></div></div>
									<div class="contact_info_text"><a href="manish_kunwar@hotmail.com?Subject=Hello" target="_top">manish_kunwar@hotmail.com</a></div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="<?php echo url('/'); ?>/images/planet-earth.svg" alt=""></div></div>
...
<script src="<?php echo url('/'); ?>/js/contact_custom.js"></script>
