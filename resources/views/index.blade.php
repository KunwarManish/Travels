...
<div class="super_container">
		...
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item home_slider_item">
					<!-- Image -->
					<div class="home_slider_background" style="background-image:url(<?php echo url('/'); ?>/images/home_slider2.jpg)"></div>
				...
				<!-- Slider Item -->
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(<?php echo url('/'); ?>/images/home_slider.jpg)"></div>
				...
				<!-- Slider Item -->
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(<?php echo url('/'); ?>/images/home_slider3.jpg)"></div>
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="intro_text text-center">
						<p>WE'RE LOCALS! We bargain best deals for you. Lowest Price is Always Guaranteed! When local starts to compete, 
								its always best for customers. The are fair traders. All the operators and their products listed in Travels are Verified. </p>
					</div>
				</div>
			</div>
			<div class="row intro_items">
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						...
						<!-- Image -->
						<div class="intro_item_background" style="background-image:url(<?php echo url('/'); ?>/images/intro_1.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							...
							<div class="intro_center text-center">
								<h1>Mauritius</h1>
								<div class="intro_price">From $1250</div>
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						<div class="intro_item_overlay"></div>
						<!-- Image -->
						<div class="intro_item_background" style="background-image:url(<?php echo url('/'); ?>/images/swoyambhu.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							<div class="intro_date">May 25th - June 01st</div>
							<div class="button intro_button"><div class="button_bcg"></div><a href="#">see more<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						<div class="intro_item_overlay"></div>
						<!-- Image -->
						<div class="intro_item_background" style="background-image:url(<?php echo url('/'); ?>/images/thailand.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							<div class="intro_date">May 25th - June 01st</div>
							<div class="button intro_button"><div class="button_bcg"></div><a href="#">see more<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1>Thailand</h1>
								<div class="intro_price">From $999</div>
								<div class="rating rating_4">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
	...
	<div class="cta">
		<!-- Image -->
		<div class="cta_background" style="background-image:url(<?php echo url('/'); ?>/images/cta.jpg)"></div>
				...
				<div class="col">
					...
					<div class="cta_slider_container">
						<div class="owl-carousel owl-theme cta_slider">
							...
							<div class="cta_background" style="background-image:url(<?php echo url('/'); ?>/images/nepal.jpg)"></div>
								<div class="cta_title">nepal deluxe package</div>
								...
								<p class="cta_text">We are committed to offering travel services of the highest quality, combining our energy and enthusiasm, with our years of experience. Our greatest satisfaction comes in serving large numbers of satisfied clients who have experienced the joys and inspiration of travel.</p>
								<div class="button cta_button"><div class="button_bcg"></div><a href="#">book now<span></span><span></span><span></span></a></div>
							</div>

							<!-- CTA Slider Item -->
							<div class="owl-item cta_item text-center">
							<div class="cta_background" style="background-image:url(<?php echo url('/'); ?>/images/maldive.jpg)"></div>
							...
							<!-- CTA Slider Item -->
							<div class="owl-item cta_item text-center">
							<div class="cta_background" style="background-image:url(<?php echo url('/'); ?>/images/vietnam.jpg)"></div>
								<div class="cta_title">Vietnam deluxe package</div>
								<div class="rating_r rating_r_4">
									<i></i>
									<i></i>
									<i></i>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									...
									<div class="offer_name"><a href="#">Soaltee Hotel</a></div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="offers_content">
									...
									<p class="offers_text">Luxurious accommodation in Kathmandu is provided at Crowne Plaza Hotel Kathmandu-Soaltee, spread over 12 acres of peaceful gardens.</p>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									...
									<div class="offer_name"><a href="#">Hôtel Le Cep</a></div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="offers_content">
									...
									<p class="offers_text">The Hotel Le Cep and Spa Marie de Bourgogne, member of the Small Luxury Hotels of the World and Chateaux & Hotels Collection.</p>
									<div class="offers_icons">
										<ul class="offers_icons_list">
											<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/post.png" alt=""></li>
											<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/compass.png" alt=""></li>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									...
									<div class="offer_name"><a href="#">Grand Hyatt Goa</a></div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="offers_content">
									...
									<p class="offers_text">Elegant, contemporary rooms come with terraces, flat-screen TVs, free Wi-Fi and minibars, plus tea and coffeemaking facilities.</p>
									<div class="offers_icons">
										<ul class="offers_icons_list">
											<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/post.png" alt=""></li>
											<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/compass.png" alt=""></li>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									...
									<div class="offer_name"><a href="#">hotel löwen </a></div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="offers_content">
									...
									<p class="offers_text">Featuring a heated pool with sauna and a terrace with panoramic views of Mount Feldberg, this traditional hotel in St. Märgen.</p>
									<div class="offers_icons">
										<ul class="offers_icons_list">
											<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/post.png" alt=""></li>
											<li class="offers_icons_item"><img src="<?php echo url('/'); ?>/images/compass.png" alt=""></li>
				...
				<div class="col">
					...
					<div class="test_slider_container">
						<div class="owl-carousel owl-theme test_slider">
							...
							<div class="owl-item">
								<div class="test_item">
									<div class="test_image"><img src="<?php echo url('/'); ?>/images/test_9.jpg" alt="https://unsplash.com/@anniegray"></div>
									...
									<div class="test_content_container">
										<div class="test_content">
											...
											<p class="test_quote_text">They offered us reasonable rates with excellent service.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="test_item">
									...
									<div class="test_content_container">
										<div class="test_content">
											...
											<p class="test_quote_text">One of the most organised well planned trips we have taken . </p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="footer_content footer_contact">
							<ul class="contact_info_list">
								...
								<li class="contact_info_item d-flex flex-row">
									...
									<div class="contact_info_text"><a href="mailto:contactme@gmail.com?Subject=Hello" target="_top">manish_kunwar@hotmail.com</a></div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="<?php echo url('/'); ?>/images/planet-earth.svg" alt=""></div></div>
									<div class="contact_info_text"><a href="https://www.linkedin.com/in/manishkunwar/">Manish Kunwar</a></div>
								</li>
							</ul>
						</div>
					</div>
